...
function HomePage() {
  ...
  const currentBook = homeUser?.currentlyReading?.[0] || null;
    ...
    <div className="home-page">
            ...
            <>
              ...
              <div className="home-currently-content">
                ...
                <div className="home-progress-top">
                  ...
                  <span>
                    Página {currentPage} de {currentBook.pages}
                  </span>
                </div>
        ...
        <div className="home-nook-grid">
          <div className="nook-card sound-card">
            ...
            <div className="sound-buttons">
              <button
                className={activeSound === "rain" ? "sound-btn active" : "sound-btn"}
              ...
              <button
                className={activeSound === "fire" ? "sound-btn active" : "sound-btn"}
              ...
              <button
                className={activeSound === "cafe" ? "sound-btn active" : "sound-btn"}
      ...
      #eadfd6 100%
            ...
            <div className="timer-actions">
              {!isRunning ? (
                <button type="button" className="timer-main-btn" onClick={startTimer}>
                  Empezar sesión
                </button>
              ) : (
                <button type="button" className="timer-main-btn" onClick={pauseTimer}>
                  Pausar
                </button>
              )}

              <button type="button" className="timer-secondary-btn" onClick={resetTimer}>
                Reiniciar
              </button>
            </div>
          </div>
        ...
        <div className="tea-section">
          ...
          <div className="tea-featured-card">
            ...
            <div className="tea-featured-content">
              ...
              <p>
                Una infusión suave y reconfortante para lecturas tranquilas, pausadas y
                de esas que apetece saborear sin prisa.
              </p>
            </div>
            <a href="https://www.myrealfood.app/es/recipe/mhnEWn71Tpq2iZKwLUDu" target="_blank">
          ...
          <div className="tea-grid">
            <a href="https://www.myrealfood.app/es/recipe/SxFdoyPcTuZnvq3V9XTZ" target="_blank" className="tea-link">
              <div className="tea-card">
                <div className="tea-card-icon">☕</div>
                <h4>Earl Grey para misterio</h4>
                <p>
                  Cítrico e intenso, perfecto para seguir pistas y perderte en giros
                  inesperados.
                </p>
              </div>
            </a>
            <a href="https://www.myrealfood.app/es/recipe/z58aJycv1ARmiNzoFcG7" target="_blank" className="tea-link">
              <div className="tea-card">
                <div className="tea-card-icon">✿</div>
                <h4>Matcha para aprender</h4>
                <p>
                  Enérgico pero sereno, ideal para ensayos, subrayados y lecturas más
                  profundas.
                </p>
              </div>
            </a>
